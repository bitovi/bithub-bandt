...
var RealBit = Bit.extend({
	findAll: function(params){
		return $.ajax({
			url: 'http://bithub.com/api/v4/embeds/150/entities?view=public&decision=approved&tenant_name=calm_dove_6826&image_only=true&' + $.param(params)
		});
	},
}, {});
...
var wrapCreate = function(data){
	data.tenant_name = 'calm_dove_6826';
	return {
		interaction: data
	};
};
